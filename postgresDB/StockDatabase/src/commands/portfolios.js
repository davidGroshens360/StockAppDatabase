...
module.exports = (program) => {
  ...
  portfolio
    ...
    .action(async (name, amount) => {
      ...
      if (!s) return console.log('Not logged in');
      try {
        await pool.query('CALL deposit_cash($1, $2, $3)', [s.user_id, name, amount]);
  ...
  portfolio
    ...
    .action(async (name, amount) => {
      ...
      if (!s) return console.log('Not logged in');
      try {
        await pool.query('CALL withdraw_cash($1, $2, $3)', [s.user_id, name, amount]);
  ...
  portfolio
    ...
    .action(async (name, symbol, shares) => {
      ...
      try {
        ...
        await pool.query('CALL buy_stock($1, $2, $3, $4, $5)', [s.user_id, name, symbol, shares, price]);
  ...
  portfolio
    ...
    .action(async (name, symbol, shares) => {
      ...
      try {
        ...
        await pool.query('CALL sell_stock($1, $2, $3, $4, $5)', [s.user_id, name, symbol, shares, price]);
